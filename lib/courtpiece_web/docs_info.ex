defmodule CourtPieceWeb.DocsInfo do
  @moduledoc """
    This module defines macro for swagger documentation
  """
          ...
          info: %{
            ...
            description:
              ~s(This is detailed api documentation for all of the client side apps to connect with our `black-boxed-server`. ) <>
                ...
                ~s(To Acquire JWT token, first of all hit `/login` endpoint, pass your login details and acquire the token. ) <>
            ...
            Bearer: %{
              ...
              description:
                ~s(For accessing the API a valid JWT token must be passed in all the queries in the 'Authorization' header.\n\n) <>
                  ~s(A valid JWT token is generated by the API and returned as answer of a call to the route **/login** giving a valid app, login and password.\n\n\n) <>
